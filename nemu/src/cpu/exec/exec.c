...
opcode_entry opcode_table [512] = {
  ...
  /* 0x62 */	IDEXW(r,pop,4), IDEXW(r,pop,4), IDEXW(r,pop,4), IDEXW(r,pop,4),
  ...
  /* 0x90 */	EXW(nop,0), EMPTY, EMPTY, EMPTY,
  ...
  /* 0xc8 */	EMPTY, EX(leave), IDEX(I,ret), EX(ret),
  ...
  /* 0xe8 */	IDEXW(J,call,0), IDEX(J,jmp), EMPTY, IDEXW(J,jmp,1),
